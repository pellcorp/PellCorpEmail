...
public class MailService extends Service {
    ...
    private static final String ACTION_CHECK_MAIL =
        "com.pellcorp.email.intent.action.MAIL_SERVICE_WAKEUP";
    private static final String ACTION_RESCHEDULE =
        "com.pellcorp.email.intent.action.MAIL_SERVICE_RESCHEDULE";
    private static final String ACTION_CANCEL =
        "com.pellcorp.email.intent.action.MAIL_SERVICE_CANCEL";
    private static final String ACTION_SEND_PENDING_MAIL =
        "com.pellcorp.email.intent.action.MAIL_SERVICE_SEND_PENDING";
    private static final String ACTION_DELETE_EXCHANGE_ACCOUNTS =
        "com.pellcorp.email.intent.action.MAIL_SERVICE_DELETE_EXCHANGE_ACCOUNTS";

    private static final String EXTRA_ACCOUNT = "com.pellcorp.email.intent.extra.ACCOUNT";
    private static final String EXTRA_ACCOUNT_INFO = "com.pellcorp.email.intent.extra.ACCOUNT_INFO";
    private static final String EXTRA_DEBUG_WATCHDOG = "com.pellcorp.email.intent.extra.WATCHDOG";
