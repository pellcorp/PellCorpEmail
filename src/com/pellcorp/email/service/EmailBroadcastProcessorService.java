...
public class EmailBroadcastProcessorService extends IntentService {
    ...
    private static final String ACTION_DEVICE_POLICY_ADMIN = "com.pellcorp.email.devicepolicy";
    ...
    /**
     * Entry point for {@link com.pellcorp.email.SecurityPolicy.PolicyAdmin}.  These will
     * simply callback to {@link
     * com.pellcorp.email.SecurityPolicy#onDeviceAdminReceiverMessage(Context, int)}.
     */
