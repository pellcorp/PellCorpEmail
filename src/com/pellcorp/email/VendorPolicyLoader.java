 ...
 *
 * <p>Email vendor policy is a system apk named "com.pellcorp.email.helper".  When exists, it must
 * contain a class called "com.pellcorp.email.policy.EmailPolicy" with a static public method
...
public class VendorPolicyLoader {
    private static final String POLICY_PACKAGE = "com.pellcorp.email.policy";
