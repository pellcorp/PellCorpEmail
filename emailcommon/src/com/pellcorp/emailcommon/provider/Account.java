...
public final class Account extends EmailContent implements AccountColumns, Parcelable {
     ...
     * TODO define sentinel values for "all", "1 month", etc.  See Account.java
     * @param value One of the {@link com.pellcorp.emailcommon.service.SyncWindow} constants
     */
     ...
     * {@code content://com.pellcorp.email.provider/account/UUID} format, which is safe to use
     * for desktop shortcuts.
     *
     * <p>We don't want to store _id in shortcuts, because
     * {@link com.pellcorp.email.provider.AccountBackupRestore} won't preserve it.
     */
    ...
    /**
     * Parse {@link Uri} in the {@code content://com.pellcorp.email.provider/account/ID} format
     ...
     * (non-Javadoc)
     * @see com.pellcorp.email.provider.EmailContent#save(android.content.Context)
     */
    @Override
